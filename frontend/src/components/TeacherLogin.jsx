  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/login/teacher`,
        formData
      );
      ...
      dispatch(addUser(response.data.trueTeacher));
      setTimeout(() => {
        navigate("/home");
      }, 1000);
    } catch (error) {
    ...
    <div className="font-[sans-serif] text-[#333] w-[55%] mx-auto h-full ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 items-center gap-8 h-full shadow-xl">
        <div className="h-full flex items-center relative max-md:before:hidden ">
          <img
            src="../login.svg"
            className="rounded-md lg:w-4/5 md:w-11/12 z-50 relative animate-pulse hover:animate-spin"
        ...
        >
          <div>
            <h3 className="text-4xl font-extrabold poppins-bold mb-10">
              Teacher Login
            </h3>
          </div>
          <div>
          ...
          <div className="mt-6">
            ...
            <div className="relative flex items-center">
              <input
                ...
                required
                className="w-full text-sm bg-gray-100 px-4 py-4 rounded-md poppins-medium outline-blue-600"
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="w-full shadow-xl py-3 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 poppins-bold focus:outline-none"
            >
              Log in
            </button>
          </div>
